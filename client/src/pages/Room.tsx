    ...
    <div className="h-[100dvh] bg-gradient-to-br from-slate-900 to-slate-950 text-white relative overflow-hidden font-sans flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto no-scrollbar p-6 md:p-8 z-10">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          {/* Right Sidebar */}
          <div className="lg:col-span-1 flex flex-col gap-6 h-[80vh] lg:h-[calc(100vh-8rem)]">
            ...
            <div className="flex-1 min-h-[300px] lg:min-h-0 glass-panel rounded-2xl overflow-hidden flex flex-col">
              <ChatPanel 
                socket={socket} 
                code={code as string} 
